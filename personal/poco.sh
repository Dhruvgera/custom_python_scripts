...
git clone https://github.com/Dhruvgera/RockstarKernel_beryllium.git -b rebase2 kernel/xiaomi/beryllium --depth=1 
...
devicename="beryllium" bash $HOME/cygnus/scripts/CI/main.sh
